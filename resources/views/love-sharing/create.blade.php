<x-app-layout>
    <div class="p-6 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold mb-4">Request Love Sharing</h1>
        ...
        <form method="POST" action="{{ route('love-sharing.store') }}" class="space-y-4">
            @csrf
            ...
            <div>
                <label class="block font-medium">Description / Message</label>
            ...
            <div>
                ...
                <textarea name="additional_information" rows="3" class="w-full border rounded p-2">{{ old('additional_information') }}</textarea>
            </div>
